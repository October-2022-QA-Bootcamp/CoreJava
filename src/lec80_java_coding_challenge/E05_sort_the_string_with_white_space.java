...
public class E05_sort_the_string_with_white_space {
	...
	public static void main(String[] args) {
		// Custom string input
		String s = "yakbz5o27leux4w Rq9LAc3KMBm80    hjgjhjhj67786";
		// We remove the white space by below line
		// where \\s is a single space in unicode
		s = s.replaceAll("\\s", ""); // no need of this line if no white space
		// System.out.println(s); // to see space is removed
		// How to Convert a string into an array of character
