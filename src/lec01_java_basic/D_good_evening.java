...
public class D_good_evening {
	...
	public static void main(String[] args) {
		// Here System is a (built in class --> java people provided this) class, out is a properties,
		// println() is a method
		System.out.println("Good Evening");
		System.out.println("How are you all?");
		// How to copy a line?
		// First put the cursor at the end of last line, then
		// For Windows User --> alt + control + up/down arrow
		// For Mac User --> option/alt + command + up/down arrow
		...
		// But you can rename class, Enum, Abstract class, Interface or package
