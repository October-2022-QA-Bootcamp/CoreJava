...
public class Employee extends MountSinai  {
	...
	// Inside Parameterized Constructor, super() and super keyword do same fucntion like they do inside default constrcutor
	...
	public void empInfo () {
		...
		super.msInfo();
		super.mountSinaiInfo("Orange County", 20);
	...
	public void employeeInfo (String empName, int empId, char sex, boolean fullTimeEmp) {
		...
		super.msInfo();
		super.mountSinaiInfo("Staten Island", 21);
