...
public class Use_of_random_class {
	...
	public static void main(String[] args) {
		...
		Random random = new Random(); // System choosing randomly, no input, so no System.in
		...
		// Exception -- java.lang.IllegalArgumentException: bound must be positive, negative range can't be used in Random class
